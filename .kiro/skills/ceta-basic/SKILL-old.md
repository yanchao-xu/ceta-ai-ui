...
| 文档                | 路径                                              | 内容                                                                      |
| ------------------- | ------------------------------------------------- | ------------------------------------------------------------------------- |
| schemaJson 结构规范 | `skills/ceta/references/schema-rules.md`          | 顶层结构、组件节点通用字段、validation 校验、字段类型映射、组件名新旧对照 |
| HTML 映射规则       | `skills/ceta/references/html-mapping-rules.md`    | HTML class/元素 → CETA 组件的映射规则                                     |
| 样式映射规则        | `skills/ceta/references/style-mapping-rules.md`   | HTML CSS 样式 → JSON style/componentProps.style 的映射规则                |

### 组件文档（按需读取）

| 目录                                        | 包含组件                                          | 适用场景     |
| ------------------------------------------- | ------------------------------------------------- | ------------ |
| `skills/ceta/references/components/input/`  | Input、Select、DatePicker、Switch、Upload、others | 表单转换     |
| `skills/ceta/references/components/layout/` | Card、Grid、Collapse、others                      | 表单和列表页 |
| `skills/ceta/references/components/display/`| Table、Tabs、Button、others                       | 列表页转换   |
