...
```json
{
  ...
  "fields": [
    ...
    { "component": "Textarea", "id": "note", "title": "备注", "componentProps": { "rows": 4 } },
    { "component": "DatePicker", "id": "date", "title": "日期", "componentProps": { "showTime": true } },
    {
            ...
            "items": [
              {
                ...
                "fields": [
                  {
                    "component": "Grid",
                    "componentProps": { "blankChildPlace": false, "colNumber": 2 },
                    "fields": [
                      { "id": "name", "title": "姓名", "component": "Input" },
                      { "id": "phone", "title": "电话", "component": "Input" }
                    ]
